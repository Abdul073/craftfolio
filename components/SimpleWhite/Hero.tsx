        ...
        <div className="max-w-[90%] mx-auto px-4 pb-0 sm:px-6 lg:px-8">
          <main className="grid grid-cols-1 lg:grid-cols-4 gap-4">
            ...
            <EditButton styles='right-0 -top-16' sectionName="contact"/>
              ...
              <div className="relative bg-gradient-to-br from-white to-primary-100 p-6 rounded-lg shadow-lg border-2 border-primary-100 hover:border-black/20 border-transparent transition-all duration-300">
